                    ...
                    if($vysledek->rowCount() > 0) {
                        ...
                        foreach ($vysledek as $polozka) {
                            ...
                            <tr>
                                ...
                                <td><a href="pritel_rozkoukane.php?id=<?=htmlspecialchars($polozka['ID'])?>&jmeno=<?=htmlspecialchars($polozka['JMENO'])?>"><?php echo $pocet_rozkoukanych?></a></td>
                                <td><a href="pritel_oblibene.php?id=<?=htmlspecialchars($polozka['ID'])?>&jmeno=<?=htmlspecialchars($polozka['JMENO'])?>"><?php echo $pocet_oblibenych?></a></td>
                                <td>
