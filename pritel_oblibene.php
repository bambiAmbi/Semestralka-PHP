...
$sql_anime = "SELECT * FROM OBLIBENE LEFT JOIN ANIME ON OBLIBENE.ANIME_ID=ANIME.ID WHERE USER_Id='$id_pritele' ";
...
<div class="main2">
    ...
    <div class="body">
        <h1>Oblíbené uživatele: <?php echo htmlspecialchars($jmeno_pritele)?></h1>
        ...
        <main>
            ...
            <div class="karta">
                ...
                <div class="info">
                    <a href="stranka_anime.php?id=<?=htmlspecialchars($vybrane_anime['ID'])?>"><p class="nazev_a">Název: <?php echo $vybrane_anime["NAZEV_ENG"] ?></p></a>
